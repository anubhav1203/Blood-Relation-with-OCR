...
# Open the file containing the pickled object in binary mode ('rb')
with open(r'E:\Capstone project\new1\svc.pkl', 'rb') as file:
...
def home():
    ...
    if form.validate_on_submit():
        ...
        if file_name.endswith('.jpg'):
            ...
            img=Image.open(r"E:\Capstone project\new1\static\files"+file_name)
